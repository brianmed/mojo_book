...
\lstinputlisting[caption={Index Route}, language=Perl, firstline=3, lastline=7]{ex2_1.pl}
...
\begin{lstlisting}[style=BashOutputStyle]
$ curl -v --cookie jar --cookie-jar jar http://127.0.0.1:3001/
*   Trying 127.0.0.1...
...
Without user input the web would be boring.  We need the user's data so that
we can do meaningful work.  A large percentage of user data originates from forms.
...
\lstinputlisting[caption={Index Route}, language=Perl, numbers=none, firstline=35, lastline=35]{photo/lib/Photo.pm}
...
\lstinputlisting[caption={Setup}, language=Perl, firstline=8, lastline=10]{photo/lib/Photo.pm}
...
\lstinputlisting[caption={Configuration}]{photo.config}
...
\lstinputlisting[caption={Secrets setup}, language=Perl, numbers=none, firstline=12, lastline=12]{photo/lib/Photo.pm}
...
\lstinputlisting[caption={Under route}, language=Perl, firstline=21, lastline=35]{photo/lib/Photo.pm}
...
\lstinputlisting[caption={Initial routes}, language=Perl, firstline=41, lastline=49]{photo/lib/Photo.pm}
...
\lstinputlisting[caption={Session route}, language=Perl, firstline=51, lastline=54]{photo/lib/Photo.pm}
...
\lstinputlisting[caption={Landing page logic}, language=Perl, firstline=8, lastline=24]{photo/lib/Photo/Controller/Index.pm}
...
\lstinputlisting[caption={Error handling}, language=Html, firstline=13, lastline=24]{photo/templates/album/create.html.ep}
...
\lstinputlisting[caption={Form start}, language=Html, firstline=29, lastline=29]{photo/templates/album/create.html.ep}
...
\lstinputlisting[caption={Switching albums error checking}, language=Perl, firstline=27, lastline=35]{photo/lib/Photo/Controller/Album.pm}
...
\lstinputlisting[caption={Switching albums logic}, language=Perl, firstline=53, lastline=57]{photo/lib/Photo/Controller/Album.pm}
...
\lstinputlisting[caption={Viewing albums}, language=Perl, firstline=17, lastline=19]{photo/lib/Photo/Controller/Album.pm}

In addition, we put some debug information in the log to demonstrate how that
operates.

\lstinputlisting[caption={Debugging example}, language=Perl, firstline=15, lastline=15]{photo/lib/Photo/Controller/Album.pm}
...
\lstinputlisting[caption={Form setup}, language=Html, firstline=38, lastline=67]{photo/templates/album/show.html.ep}
...
\lstinputlisting[caption={Album links}, language=Html, firstline=50, lastline=52]{photo/templates/album/show.html.ep}
...
\lstinputlisting[caption={Dot code}, language=Html, firstline=87, lastline=90]{photo/templates/album/show.html.ep}
...
\lstinputlisting[caption={Display pictures}, language=Html, firstline=93, lastline=108]{photo/templates/album/show.html.ep}

Finally, we the left and right arrows over the image if there is more than photo.

\lstinputlisting[caption={Navigation}, numbers=none, language=Html, firstline=110, lastline=113]{photo/templates/album/show.html.ep}
...
\lstinputlisting[caption={Upload form}, numbers=none, language=Html, firstline=38, lastline=38]{photo/templates/album/show.html.ep}
...
\lstinputlisting[caption={Display photo}, language=Perl, firstline=131, lastline=142]{photo/lib/Photo/Controller/Album.pm}
...
\lstinputlisting[caption={Switch albums}, language=Perl, firstline=60, lastline=78]{photo/lib/Photo/Controller/Album.pm}
...
\lstinputlisting[caption={Helpers}, language=Perl, firstline=14, lastline=17]{blog/lib/Blog.pm}
...
\lstinputlisting[caption={Migration Logic}, language=Perl, firstline=19, lastline=21]{blog/lib/Blog.pm}

Below is the actual migration file contents.

\lstinputlisting[caption={Migration SQL}, language=SQL, firstline=1, lastline=9]{blog/migrations/blog.sql}
...
\lstinputlisting[caption={Blog routes}, language=Perl, firstline=23, lastline=32]{blog/lib/Blog.pm}
...
\lstinputlisting[caption={Initial route}, language=Perl, firstline=11, lastline=14]{blog/lib/Blog/Controller/Posts.pm}
...
\lstinputlisting[caption={Posts SQL}, language=Perl, firstline=12, lastline=12]{blog/lib/Blog/Model/Posts.pm}

The template is below and uses a layout for making templates with a common
structure easier (e.g. HTML documents).

\lstinputlisting[caption={Post template}, language=HTML]{blog/templates/posts/index.html.ep}
...
\lstinputlisting[caption={Blog layout}, language=HTML]{blog/templates/layouts/blog.html.ep}
...
\lstinputlisting[caption={Blog posts rendering}, language=Perl, firstline=13, lastline=13]{blog/lib/Blog/Controller/Posts.pm}
...
\lstinputlisting[caption={Chat database}, language=Perl, firstline=6, lastline=10]{chat/chat.pl}

Next, our index page is configured via..

\lstinputlisting[caption={Index route}, language=Perl, firstline=12, lastline=12]{chat/chat.pl}

And, uses the template here:

\lstinputlisting[caption={Chat logic}, language=HTML, numbers=none, firstline=71, lastline=80]{chat/chat.pl}
...
\lstinputlisting[caption={Websocket route}, language=Perl, firstline=14, lastline=21]{chat/chat.pl}
...
\lstinputlisting[caption={Notifications}, language=Perl, firstline=23, lastline=45]{chat/chat.pl}

The next bit 'o code will blast out and receive the chat messages via the
pubsub capabilities of Mojo::SQLite and friends.

\lstinputlisting[caption={PubSub}, language=Perl, firstline=47, lastline=51]{chat/chat.pl}
...
\lstinputlisting[caption={Cleanup}, language=Perl, firstline=53, lastline=62]{chat/chat.pl}

Finally, our app announces its presensce via a DB call.

\lstinputlisting[caption={Presence}, language=Perl, firstline=64, lastline=65]{chat/chat.pl}
...
\lstinputlisting[caption={Authentication logic}, language=Perl, firstline=4, lastline=17]{ex4_basic.pl}

If Bender is found, then one of the GET requests are served..

\lstinputlisting[caption={Protected content}, language=Perl, firstline=19, lastline=29]{ex4_basic.pl}
...
\lstinputlisting[caption={Initial route}, language=Perl, firstline=3, lastline=9]{ex4_session.pl}
...
\lstinputlisting[caption={Login logic}, language=Perl, firstline=11, lastline=35]{ex4_session.pl}
...
\lstinputlisting[caption={Logout logic}, language=Perl, firstline=37, lastline=45]{ex4_session.pl}
...
\lstinputlisting[caption={Authentication logic}, language=Perl, firstline=47, lastline=59]{ex4_session.pl}
...
\lstinputlisting[caption={Protected content}, language=Perl, firstline=74, lastline=75]{ex4_session.pl}
...
\lstinputlisting[caption={Authentication start}, language=Perl, firstline=10, lastline=19]{ex4_api.pl}
...
\lstinputlisting[caption={Validate credentials}, language=Perl, firstline=40, lastline=57]{ex4_api.pl}

Next, we have helpers for our CRUD datastore and the GET/POST routes that allow
for data retrieval and modifications.

\lstinputlisting[caption={CRUD helpers}, language=Perl, firstline=59, lastline=84]{ex4_api.pl}
...
\lstinputlisting[caption={CRUD routes}, language=Perl, firstline=117, lastline=133]{ex4_api.pl}
...
\lstinputlisting[caption={Index route}, language=Perl, firstline=4, lastline=9]{ex4_delay.pl}

The steps needed by the delay are sub CODE blocks.  The first one sets up our
concurrent requests.  This is shown below:

\lstinputlisting[caption={GET requests}, language=Perl, firstline=11, lastline=18]{ex4_delay.pl}
...
\lstinputlisting[caption={Request output}, language=Perl, firstline=20, lastline=27]{ex4_delay.pl}
...
\lstinputlisting[caption={Setup}, basicstyle=\LSTfont, language=Perl, firstline=1, lastline=9]{ex4_cli.pl}
...
\lstinputlisting[caption={Lat/Lon}, basicstyle=\LSTfont, language=Perl, firstline=10, lastline=17]{ex4_cli.pl}
...
\lstinputlisting[caption={Weather}, basicstyle=\LSTfont, language=Perl, keepspaces=true, firstline=18, lastline=30]{ex4_cli.pl}
...
\lstinputlisting[caption={Output}, basicstyle=\LSTfont, language=Perl, keepspaces=true, firstline=31, lastline=43]{ex4_cli.pl}
