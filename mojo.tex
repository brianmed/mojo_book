...
\newcommand\Small{\fontsize{12}{12.2}\selectfont}
...
\lstinputlisting[basicstyle=\LSTfont, language=Perl, firstline=57, lastline=65]{photo/lib/Photo.pm}
...
For our app, we have a landing page to select an album; the album viewer page;
and the album creation page.  However, we have the following endpoints.
