...
Modern Perl features in our script.

\lstinputlisting[basicstyle=\LSTfont, language=Perl, firstline=1, lastline=8]{ex4_cli.pl}

After this, the 1st GET request is done, and then we setup the query for the
final GET request that retrieves the weather.

\lstinputlisting[basicstyle=\LSTfont, language=Perl, keepspaces=true, firstline=13, lastline=20]{ex4_cli.pl}

Finally, the weather is output.

\lstinputlisting[basicstyle=\LSTfont, language=Perl, keepspaces=true, firstline=22, lastline=29]{ex4_cli.pl}
