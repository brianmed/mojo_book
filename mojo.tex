...
\lstinputlisting[caption={ex2\_1.pl}, language=Perl]{ex2_1.pl}

The \textbf{get '/carpe'} will redirect a \textbf{HTTP GET /carpe} request to
the anonymous subroutine listed. It should be noted that a GET and POST can be
...
\begin{center}
  \begin{tabular}{|l|l|}
    ...
    GET  & CODE\\
    \hline
    GET / & \ref{_ex2_1_index}: get "/" => sub {}\\
    GET /carpe & \ref{_ex2_1_carpe}: get "/carpe" => sub {}\\
    \hline
  \end{tabular}
\end{center}
