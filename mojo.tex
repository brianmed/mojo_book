...
\lstinputlisting[basicstyle=\LSTfont, language=Perl, firstline=13, lastline=20]{ex4_cli.pl}

Finally, the weather is output.

\lstinputlisting[basicstyle=\LSTfont, language=Perl, firstline=22, lastline=29]{ex4_cli.pl}
